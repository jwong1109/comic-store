# change function to check that the number of comics input is not zero or
# greater than the number in stock. If so, present error message and not sell.

# If the number is appropriate and reasonable, present successful message
# and sell
