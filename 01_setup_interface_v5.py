# Add the right-side labels and use labels to represent the positions of the
# dropdown and entry fields, and buttons
# Add sticky to labels and ipadx to the comic labels
# Completed Rough Structure of the program
